<div class="page-content">
  ...
  <div class="row">
    <div class="col-md-6 offset-md-3 grid-margin">
      <?php $attributes = array('class' => 'forms-sample', 'id' => 'edit', 'method'=>'post','enctype' => 'multipart/form-data'); ?>
      <?= form_open(BASE_URL . 'student-edit/' . encode_id($details->id), $attributes); ?>
      <div class="card">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" autocomplete="off" value="<?= stripslashes($details->name); ?>"/>
          </div>
          <div class="mb-3">
            <label for="subject_name" class="form-label">Subject Name<span class="text text-danger">*</span></label>
            <input type="text" class="form-control" id="subject_name" name="subject_name" autocomplete="off" value="<?= stripslashes($details->subject_name); ?>"/>
          </div>
          <div class="mb-3">
            <label for="marks" class="form-label">Marks<span class="text text-danger">*</span></label>
            <input type="text" class="form-control" id="marks" name="marks" autocomplete="off" value="<?= stripslashes($details->marks); ?>"/>
          </div>
        </div>
