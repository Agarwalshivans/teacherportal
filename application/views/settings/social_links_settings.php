<div class="page-content">
  ...
  <div class="row">
    <div class="col-md-6 offset-md-3">
      <?php $attributes = array('class' => 'forms-sample', 'id' => 'socialLinksSettingForm', 'method'=>'post','enctype'=>'multipart/form-data'); ?>
      <?= form_open(BASE_URL . 'social-links-settings', $attributes); ?>
      <div class="card">
